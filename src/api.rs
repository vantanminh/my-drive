...
pub(crate) fn router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/s/{token}/{*path}", get(serve_frontend_index))
        .route("/drive", get(serve_frontend_index))
        .route("/drive/{*path}", get(serve_frontend_index))
        .route("/shared", get(serve_frontend_index))
        .route("/trash", get(serve_frontend_index))
